            ...
            <c:choose>
                <c:when test="${not empty messages}">
                    <c:forEach var="message" items="${messages}">
                        <div class="message ${message.isFromCurrentUser ? 'sent' : ''}">
                            <c:if test="${!message.isFromCurrentUser}">
                                <div class="message-avatar">
                                    <i class="fas fa-user"></i>
                                </div>
                            </c:if>
                            <div class="message-content">
                                ...
                                <div class="message-time">
                                    <fmt:formatDate value="${message.timestamp}" pattern="HH:mm dd/MM"/>
                                </div>
                            </div>
                            <c:if test="${message.isFromCurrentUser}">
                                <div class="message-avatar">
...
<script>
    ...
    function addMessageToChat(messageData) {
        ...
        messageDiv.className = 'message ' + (messageData.isFromCurrentUser ? 'sent' : '');
        ...
        timeDiv.textContent = new Date(messageData.timestamp).toLocaleString('vi-VN', {
            hour: '2-digit',
            minute: '2-digit',
            day: '2-digit',
            month: '2-digit'
        ...
        if (messageData.isFromCurrentUser) {
