                        ...
                        <div class="row">
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="payment-option selected" data-method="COD">
                                                ...
                                                <label for="paymentCOD"
                                                    style="cursor: pointer; margin-left: 10px; margin-bottom: 0;">COD -
                                            ...
                                            <div class="payment-option" data-method="MOMO">
                                                ...
                                                <label for="paymentMOMO"
                                                    style="cursor: pointer; margin-left: 10px; margin-bottom: 0;">MoMo -
                            ...
                            <div class="col-lg-4">
                                <div class="order-summary">
                                    ...
                                    <div class="mb-4">
                                        <%-- Tìm và thay thế đoạn hiển thị danh sách sản phẩm (Dòng ~52 trong file của
                                            bạn) --%>
                                            <c:forEach var="item" items="${cart.items}">
                                                <div
                                                    class="product-item d-flex align-items-center mb-3 pb-3 border-bottom">
                                                    <div
                                                        class="product-info-wrapper d-flex align-items-center flex-grow-1">
                                                        <c:choose>
                                    ...
                                    <div class="summary-item"><span>Tạm tính:</span> <span>
                                            <fmt:formatNumber value="${cart.totalPrice}" pattern="#,##0" /> đ
                                        </span></div>
                                    <div class="summary-item"><span>Phí vận chuyển:</span> <span>25,000 đ</span></div>
                                    <div class="summary-item pt-3 border-top">
                                        <span>Tổng cộng:</span>
                                        <span class="text-primary fw-bold">
                                            <fmt:formatNumber value="${cart.totalPrice + 25000}" pattern="#,##0" /> đ
                                        </span>
                                    </div>
                                    <button type="button" onclick="handleCheckout()"
                                        class="btn btn-checkout w-100 mt-3">Đặt hàng ngay</button>
                                </div>
                            </div>
                        </div>
                    </div>
