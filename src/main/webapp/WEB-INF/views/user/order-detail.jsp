                ...
                <body>
                    ...
                    <div class="order-detail-header">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <h1 class="mb-3"><i class="fas fa-receipt me-3"></i>Chi tiết đơn hàng #${order.id}
                                    </h1>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb bg-transparent p-0 mb-0">
                                            <li class="breadcrumb-item"><a href="<c:url value='/user/home'/>"
                                                    class="text-white-50">Trang chủ</a></li>
                                            <li class="breadcrumb-item"><a href="<c:url value='/user/orders'/>"
                                                    class="text-white-50">Đơn hàng</a></li>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${not empty item.productImage}">
                                                            <img src="<c:url value='/files/${item.productImage}'/>"
                                                                alt="${item.productNameVi}" class="product-image me-3">
                                                        </c:when>
                                                        <c:otherwise>
                                                            <div
                                                                class="product-image bg-light d-flex align-items-center justify-content-center me-3 border">
                                ...
                                <div class="order-detail-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${order.status == 'SHIPPING'}">
                                            <form method="post"
                                                action="<c:url value='/user/orders/${order.id}/confirm-delivered'/>"
                                                onsubmit="return confirm('Bạn có chắc chắn đã nhận được hàng? Đơn hàng sẽ chuyển sang trạng thái đã giao.');">
