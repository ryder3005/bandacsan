                ...
                <c:choose>
                    <c:when test="${not empty cart and not empty cart.items}">
                        <c:forEach var="item" items="${cart.items}" varStatus="status">
                            <div class="cart-item animate__animated animate__fadeInUp" style="animation-delay: ${status.index * 0.1}s">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mt-2">
                                            <span class="badge bg-primary">
                                                <fmt:formatNumber value="${item.productPrice}" pattern="#,##0" /> đ
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <form method="post" action="<c:url value='/vendor/cart/update'/>" class="d-inline">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control quantity-input" id="quantity-${item.id}" name="quantity"
                                    ...
                                    <div class="col-md-1">
                                        <form method="post" action="<c:url value='/vendor/cart/remove'/>" class="d-inline"
                        ...
                        <div class="text-center mb-4">
                            <form method="post" action="<c:url value='/vendor/cart/clear'/>" class="d-inline"
