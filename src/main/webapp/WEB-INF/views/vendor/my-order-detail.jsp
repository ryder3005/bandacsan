            ...
            <div class="col-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent p-0 mb-0">
                        <li class="breadcrumb-item"><a href="<c:url value='/'/>" class="text-white-50">Trang chủ</a></li>
                        <li class="breadcrumb-item"><a href="<c:url value='/vendor/my-orders'/>" class="text-white-50">Đơn hàng</a></li>
            ...
            <div class="order-detail-card">
                ...
                <div class="card-body">
                    ...
                    <c:if test="${order.status == 'SHIPPING'}">
                        <form method="post" action="<c:url value='/vendor/my-orders/${order.id}/confirm-delivered'/>" onsubmit="return confirm('Bạn có chắc chắn đã nhận được hàng? Đơn hàng sẽ chuyển sang trạng thái đã giao.');">
                            <button type="submit" class="btn btn-success w-100">
                                <i class="fas fa-check-circle me-2"></i>Xác nhận đã nhận hàng
                            </button>
                        </form>
                    </c:if>
                    <a href="<c:url value='/vendor/my-orders'/>" class="btn btn-outline-secondary w-100 mt-2">
