...
<head>
    ...
    <title>Chi tiết đơn hàng #${order.id} - Vendor</title>
...
<div class="order-detail-header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="mb-3"><i class="bi bi-receipt me-3"></i>Chi tiết đơn hàng #${order.id}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent p-0 mb-0">
                        <li class="breadcrumb-item"><a href="<c:url value='/vendor/orders'/>" class="text-white-50">Đơn hàng</a></li>
...
<div class="container">
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="order-detail-card">
                <div class="order-detail-card-header">
                    <h4 class="mb-0"><i class="bi bi-bag me-2"></i>Sản phẩm</h4>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="order-detail-card">
                <div class="order-detail-card-header">
                    <h4 class="mb-0"><i class="bi bi-info-circle me-2"></i>Thông tin đơn hàng</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <c:if test="${order.status == 'PENDING'}">
                        <form method="post" action="<c:url value='/vendor/orders/${order.id}/confirm'/>" onsubmit="return confirm('Bạn có chắc chắn muốn xác nhận đơn hàng này? Đơn hàng sẽ chuyển sang trạng thái đang giao.');">
                            <button type="submit" class="btn btn-success w-100">
                                <i class="bi bi-check-circle me-2"></i>Xác nhận đơn hàng
                            </button>
                        </form>
                    </c:if>
                    <a href="<c:url value='/vendor/orders'/>" class="btn btn-outline-secondary w-100 mt-2">
