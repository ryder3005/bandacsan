                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                <div class="welcome-badge animate__animated animate__fadeInLeft">
                                    ...
                                    Chào mừng Vendor: <strong>
                                        <c:out
                                            value="${sessionScope.user != null ? sessionScope.user.username : 'Vendor'}" />
                                    </strong>
                                </div>
                                <h1 class="animate__animated animate__fadeInUp">Quản lý cửa hàng của bạn</h1>
                                <p class="lead animate__animated animate__fadeInUp animate__delay-1s">
                                    Nơi bạn có thể quản lý sản phẩm, theo dõi đơn hàng và phát triển kinh doanh hiệu
                                    quả.
                                </p>
                            </div>
                            <div class="col-lg-4 text-center">
                                <i class="fas fa-store-alt animate__animated animate__bounceIn"
                                    style="font-size: 8rem; color: rgba(255,255,255,0.8);"></i>
                            </div>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="activity-item">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted small mb-0">Bạn có thể thêm sản phẩm mới vào cửa hàng
                                            </p>
                                        </div>
                                    </div>
                                </div>
